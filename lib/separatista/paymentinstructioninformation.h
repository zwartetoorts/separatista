...
namespace SeparatistaPrivate
{
	...
	DECLARE_CHILD(PartyIdentification32, Creditor, Cdtr)
	...
	DECLARE_CHILD(PartyIdentification32, UltimateCreditor, UltmtCdtr)
	DECLARE_CHILD(PartyIdentification32, CreditorSchemeIdentification, CdtrSchmeId)
