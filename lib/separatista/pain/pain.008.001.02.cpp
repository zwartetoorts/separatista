...
#include "pain.008.001.02.h"

namespace Separatista
{
	namespace pain_008_001_02
	{
		const wchar_t* Namespace = TEXT("urn:iso:std:iso:20022:tech:xsd:pain.008.001.02");
		...
		static const Separatista::ElementDescriptor AmendmentInformationDetails6 =
		{
			NULL,												// Parent type
			...
			AmendmentInformationDetails6ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor AmendmentInformationDetails6ChildElements[] =
		{


			{
				SEPARATISTA_TAG("OrgnlMndtId"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlCdtrSchmeId"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlCdtrAgt"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlCdtrAgtAcct"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlDbtrAcct"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlDbtrAgt"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlDbtrAgtAcct"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlFnlColltnDt"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("OrgnlFrqcy"),				// Tag
				0,										// Min
				1,										// Max

				&Frequency1Code								// ElementDescriptor
			},
		...
		static const Separatista::ElementDescriptor CustomerDirectDebitInitiationV02 =
		{
			NULL,												// Parent type
			...
			NULL,												// Validator
			2,												// Child element count
			CustomerDirectDebitInitiationV02ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor CustomerDirectDebitInitiationV02ChildElements[] =
		{
...

			{
				...
				&GroupHeader39								// ElementDescriptor
			},
...

			{
				...
				&PaymentInstructionInformation4								// ElementDescriptor
			},
		...
		static const Separatista::ElementDescriptor DirectDebitTransaction6 =
		{
			NULL,												// Parent type
			...
			NULL,												// Validator
			4,												// Child element count
			DirectDebitTransaction6ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor DirectDebitTransaction6ChildElements[] =
		{


			{
				SEPARATISTA_TAG("MndtRltdInf"),				// Tag
				0,										// Min
				1,										// Max

				&MandateRelatedInformation6								// ElementDescriptor
			},



			{
				SEPARATISTA_TAG("CdtrSchmeId"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("PreNtfctnId"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("PreNtfctnDt"),				// Tag
				0,										// Min
				1,										// Max
		...
		static const Separatista::ElementDescriptor DirectDebitTransactionInformation9 =
		{
			NULL,												// Parent type
			...
			DirectDebitTransactionInformation9ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor DirectDebitTransactionInformation9ChildElements[] =
		{
...

			{
				...
				&PaymentTypeInformation20								// ElementDescriptor
			},
			...
			{
				SEPARATISTA_TAG("DrctDbtTx"),				// Tag
				0,										// Min
				1,										// Max

				&DirectDebitTransaction6								// ElementDescriptor
			},
		...
		static const Separatista::ChildElementDescriptor DocumentChildElements[] =
		{
			...
			{
				SEPARATISTA_TAG("CstmrDrctDbtInitn"),				// Tag

				1,																		// Min

				1,																		// Max

				&CustomerDirectDebitInitiationV02								// ElementDescriptor
			},
		...
		void validate_Frequency1Code(const wchar_t *pValue, Separatista::Element *pElement)
		{
		...
		static const Separatista::ElementDescriptor Frequency1Code =
		{
			NULL,												// Parent type
			Separatista::LeafElement::createElement,							// Creator
			validate_Frequency1Code ,	// Validator
			0,													// Child elements
			NULL												// ChildElement descriptors
		};
		...
		static const Separatista::ElementDescriptor GroupHeader39 =
		{
			NULL,												// Parent type
			...
			NULL,												// Validator
			7,												// Child element count
			GroupHeader39ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor GroupHeader39ChildElements[] =
		{
		...
		static const Separatista::ElementDescriptor MandateRelatedInformation6 =
		{
			NULL,												// Parent type
			...
			MandateRelatedInformation6ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor MandateRelatedInformation6ChildElements[] =
		{
			...
			{
				SEPARATISTA_TAG("AmdmntInfDtls"),				// Tag
				0,										// Min
				1,										// Max

				&AmendmentInformationDetails6								// ElementDescriptor
			},



			{
				SEPARATISTA_TAG("ElctrncSgntr"),				// Tag
				0,										// Min
				1,										// Max

				&Max1025Text								// ElementDescriptor
			},



			{
				SEPARATISTA_TAG("FrstColltnDt"),				// Tag
				0,										// Min
				1,										// Max
			...
			{
				SEPARATISTA_TAG("FnlColltnDt"),				// Tag
				0,										// Min
				1,										// Max
		...
		void validate_Max1025Text(const wchar_t *pValue, Separatista::Element *pElement)
		{
			...
			Separatista::Validator::validateMaxLength(pValue, TEXT("1025"), pElement);

		}

		static const Separatista::ElementDescriptor Max1025Text =
		{
			NULL,												// Parent type
			Separatista::LeafElement::createElement,							// Creator
			validate_Max1025Text ,	// Validator
			0,													// Child elements
			NULL												// ChildElement descriptors
		};
		...
		static const Separatista::ElementDescriptor PaymentInstructionInformation4 =
		{
			NULL,												// Parent type
			...
			NULL,												// Validator
			17,												// Child element count
			PaymentInstructionInformation4ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor PaymentInstructionInformation4ChildElements[] =
		{
...

			{
				...
				&PaymentMethod2Code								// ElementDescriptor
			},
			...
			{
				SEPARATISTA_TAG("ReqdColltnDt"),				// Tag
			...
			{
				SEPARATISTA_TAG("DrctDbtTxInf"),				// Tag
				1,										// Min

				0,																		//Max

				&DirectDebitTransactionInformation9								// ElementDescriptor
			},
		...
		void validate_PaymentMethod2Code(const wchar_t *pValue, Separatista::Element *pElement)
		{
		...
		static const Separatista::ElementDescriptor PaymentMethod2Code =
		{
			NULL,												// Parent type
			Separatista::LeafElement::createElement,							// Creator
			validate_PaymentMethod2Code ,	// Validator
			0,													// Child elements
			NULL												// ChildElement descriptors
		};


		static const Separatista::ElementDescriptor PaymentTypeInformation20 =
		{
			NULL,												// Parent type
			...
			NULL,												// Validator
			5,												// Child element count
			PaymentTypeInformation20ChildElements											// Child element descriptors
		};

		static const Separatista::ChildElementDescriptor PaymentTypeInformation20ChildElements[] =
		{
			...
			{
				SEPARATISTA_TAG("SeqTp"),				// Tag
				0,										// Min
				1,										// Max

				&SequenceType1Code								// ElementDescriptor
			},
		...
		void validate_SequenceType1Code(const wchar_t *pValue, Separatista::Element *pElement)
		{
		...
		static const Separatista::ElementDescriptor SequenceType1Code =
		{
			NULL,												// Parent type
			Separatista::LeafElement::createElement,							// Creator
			validate_SequenceType1Code ,	// Validator
			0,													// Child elements
			NULL												// ChildElement descriptors
		};
